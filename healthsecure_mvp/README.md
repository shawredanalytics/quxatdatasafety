...
Lightweight Streamlit MVP for healthcare organizations to:
...
2. Navigate to the `healthsecure_mvp` directory.
...
5. Create a `.env` file based on `.env.example` and adjust values as needed.

## 3. Run Locally

From the `healthsecure_mvp` directory:
...
3. Select your GitHub repo and choose `healthsecure_mvp/app.py` as the entry point.
